...
public class UseSHA {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("SHA-512:"+sha3.equals("fwxa1+U2xPgtslyVh8C9QxsCng1i7W5TowlmU+F/ETrDKSSTsIcdrqFFPeae4vLgyaBpAzhYHklEkOuSp0V7Pg=="));
			...
			//암호화
			 ...
			 //'이준원','lee@test.com'
			 String chipherText=de.encrypt("최수영");
			 System.out.println("ㅇㅇㅇ"+chipherText);
