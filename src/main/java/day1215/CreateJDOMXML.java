...
public class CreateJDOMXML {
	...
	public static void main(String[] args) {
		...
		try {
			...
			FileOutputStream fos = new FileOutputStream("C:/dev/workspace/jsp_prj/src/main/webapp/xml1215/mag.xml");
			xout.output(doc, fos);
		} catch (IOException e) {
			e.printStackTrace();
		}//end catch
