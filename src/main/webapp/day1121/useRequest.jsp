...
<ul>
	...
	<li>요청 파라메터값: <%= request.getParameter("nick")%></li>
	<li>요청 파라메터값: <%= request.getParameter("age")%></li>
	<li>
	...
	<%
		...
		%>
		이름 : <%= headerName %>, 값 : <%= request.getHeader(headerName) %>
		<br>
		<% }
	%>
...
<!-- form 태그에 action 속성을 사용하지 않으면 기본저긍로 자신 페이지르 요청한다. -->
