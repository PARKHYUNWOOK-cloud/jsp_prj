...
function postSend(){
	...
	document.frm.submit(); //JS를 이용한 이동
}
</script>
...
<div id="wrap">
	...
	<form action="getParameterValuesFrmProcess.jsp" id="frm" name="frm" method="post">
	<strong>상황에 따라 GET 또는 POST 변환되는 방식</strong><br>
	<label>관심언어</label>
