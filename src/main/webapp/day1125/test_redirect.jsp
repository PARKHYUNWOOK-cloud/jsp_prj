...
<%
//악의적인 목적 사용자 
String[] blockIp={"192.168.10.76","192.168.10.78",
		"192.168.10.96","192.168.10.85",
		"192.168.10.83","192.168.10.73",
...
if(blockFlag){
	response.sendRedirect("https://adventure.lotteworld.com");
	return;
}//end if
%>
<!DOCTYPE html>
