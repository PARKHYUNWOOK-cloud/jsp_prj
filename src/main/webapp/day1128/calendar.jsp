...
<!--  calBody calTab sunTitle weekTitle satTitle -->
<style type="text/css">
/* 달력 객체의 디자인 */
#calWrap{
  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div id="calWrap">
					<!-- parameter 값 처리  -->
					<jsp:useBean id="cDTO" class="kr.co.sist.calender.CalendarDTO" scope="page"/>
					...
					if(paramMonth!=null){//web parameter가 존재
						//Calender 객체의 월을 0월 ~ 11월 12달을 사용.(사람의 월보다 1적다.)
						//10월이 입력되면 자바는 11월
		...
		<footer class="container">
			...
			<p>
				...
				&middot; 개인정보관리 책임자는 <strong style="color:#FF0000">너지... 나겠냐?</strong>
			</p>
		</footer>
	</main>
