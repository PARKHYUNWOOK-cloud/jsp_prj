...
<%@page import="day1201.CollectionSerivce"%>
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				<%
					...
					CollectionSerivce cs = new CollectionSerivce();				
				...
				<c:forEach var="arr" items="${ arr }" varStatus="i">
					...
					<tr>
						<td>
							<c:out value="${ i.index }"/><!-- 0번부터 시작 -->
							<c:out value="${ i.count }"/><!-- 1번부터 시작 -->
							<c:out value="${ i.first }"/><!-- 1번이니? -->
				...
				<% 
					...
					//2. scope 객체에 데이터를 추가 -> EL은 변수에 직접 접근 X
