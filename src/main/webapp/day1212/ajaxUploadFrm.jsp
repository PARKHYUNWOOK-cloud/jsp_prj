...
$(function(){
   ...
   $("#btnFileUpload").click(function(){
	   if($("#upfile").val() ==""){
	      ...
	      var formData=new FormData(form);//파라메터 전송방식 -> binary 전송 방식
         ...
         <div class="row featurette">
            <div class="col-md-7">
               ...
               -->
                ...
                <label>파일</label><br>
                <img src="../upload/chikawa.jpg" id="preview" style="width:100px; height: 100px; border-radius:50px; "/>
                
              <input type="button" value="파일선택" class="btn btn-primary btn-sm" id="btnFile"/><br>
              <input type="button" value="파일업로드" class="btn btn-info btn-sm" id="btnFileUpload"/><br>
