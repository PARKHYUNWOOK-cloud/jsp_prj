...
$(function(){
   ...
   $("#upfile").change(function(evt){
	 ...
	 /*  //업로드 가능 확장자는 gif,jpg,png,bmp만 가능 체크하는 코드 작성.
					...
					<form name="modifyFrm" method="post" id="modifyFrm"
						...
						<table id="joinFrm">
							<tr>
								...
								<td class="input"><strong><c:out value="${userId}"/></strong></td>
							</tr>
							<tr>
								<td class="input" colspan="2">
								<img src="${CommonURL}/upload/${pDTO.profile}"
								style="width:100px; height: 100px; border-radius: 50px;" id="preview"/>
								...
								<input type="file" accept="image/*" name="upfile" id="upfile" style="display:none"/><br>
              					...
              					<input type="hidden" value="${pDTO.profile}" name="profile" id="profile"/><br>
							</td>
							</tr>
							...
							<tr>
								...
								<td class="input"><input type="text" name="mail"
									value="test" />@ <select name="domain" id="domain">
							...
							<tr>
								...
								<td class="input"><select name="loc" class="inputBox" id="loc"
							...
							<tr>
								...
								<td><textarea name="intro"
										style="width: 400px; height: 100px"><c:out value="${pDTO.intro}"/></textarea></td>
							</tr>
							
							<tr>
								<td colspan="2" style="text-align: center"><input
									type="hidden" name="code" value="U3881"> <input
									type="button" value="변경" class="btn btn-success" id="btn" />
								</td>
							</tr>
						</table>
					</form>
