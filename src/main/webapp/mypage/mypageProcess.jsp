		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					...
					String profile= mr.getParameter("profile");//hiddem
					...
					//파일이 크다면 사용자에게 "에러 메시지를 보여준다." 파일을 삭제한다.
					...
					//indew.jsp에서 프로필 이미지를 세션에서 가져와서 보여주기 때문에
					//회원 정보가 변경이 성공하면 세션에 프로필 이미지를 변경해준다.
					...
					회원정보가 수정 되었습니다.<br>
					<img src="${CommonURL }/upload/chikawa.jpg"/>
					<a href="${CommonURL }/index.jsp">메인화면</a>
					</c:when>
					<c:otherwise>
					회원정보변경 시 문제가 발생하였습니다.<br>
